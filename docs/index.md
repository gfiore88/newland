# CATALOGO WIKI (KARPATHY LLM-WIKI INDEX)

> Questo catalogo è gestito e mantenuto dagli agenti AI ad ogni ingerenza di nuove fonti grezze.

---

## 📚 Fonti Ingerite (`docs/wiki/sources/`)

- [src-newland-universe-spec.md](file:///Users/giovannifiore/Desktop/newland/docs/wiki/sources/src-newland-universe-spec.md) - *Specifica Primordiale dell'Universo Parallelo Newland (Fisica, Leggi, Tabula Rasa).*
...
## 🏛️ Entità Fondative (`docs/wiki/entities/`)

- [ent-codice-inviolabile.md](file:///Users/giovannifiore/Desktop/newland/docs/wiki/entities/ent-codice-inviolabile.md) - *Le 5 Leggi primordiali di Newland (Assenza di Sovranità e Proprietà).*
- [ent-matrice-fisica.md](file:///Users/giovannifiore/Desktop/newland/docs/wiki/entities/ent-matrice-fisica.md) - *Parametri fisici, chimica atmosferica e costanti cosmologiche reali ($9.80665 m/s^2$).*
- [ent-topologia-circolare.md](file:///Users/giovannifiore/Desktop/newland/docs/wiki/entities/ent-topologia-circolare.md) - *Geometria dello spazio chiuso/sferico senza uscite.*
...
## 💡 Concetti & Modelli (`docs/wiki/concepts/`)

- [cnc-omeostasi-planetaria.md](file:///Users/giovannifiore/Desktop/newland/docs/wiki/concepts/cnc-omeostasi-planetaria.md) - *Modello matematico dell'equilibrio termodinamico a popolazione zero.*
...
- [adr-0009-supervised-runtime-and-inference-priority.md](file:///Users/giovannifiore/Desktop/newland/docs/adr/adr-0009-supervised-runtime-and-inference-priority.md) - *ADR-0009 proposto: supervisore unico e priorità agent-first per l'inferenza locale condivisa.*
