...
- [COG-002] **Structured Intentions**: The LLM will return a schema-validated intention containing action type, target, location, estimated duration, spoken content when applicable, motivation summary, and confidence. Free prose will not mutate world state.
...
- [SCH-002] **Temporal Resolution**: Deterministic systems may advance physical and physiological processes in batches. Every inhabitant intention, including routine behavioral choices, will originate from generative cognition as refined by ADR-0008.
...
- [MOD-001] **Model Routing**: A faster generative model may handle ordinary cognition; a stronger generative model may handle reflection, high-stakes conflict, or rare anamnesis events. Deterministic code will not choose inhabitant actions, as refined by ADR-0008.
...
- [NEG-002] **LLM Behavioral Instability**: Model outputs may vary or violate character constraints. - **Mitigation**: Use structured output validation, bounded generative repair, generative model failover, cognitive deferral, invariant checks, and recorded model/prompt versions; never substitute a static decision.
